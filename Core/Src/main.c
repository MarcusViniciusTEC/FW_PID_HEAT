...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, RELE_LAMP_Pin|LAMP_ENABLE_Pin|VCC_LCD_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : RELE_LAMP_Pin LAMP_ENABLE_Pin VCC_LCD_EN_Pin */
  GPIO_InitStruct.Pin = RELE_LAMP_Pin|LAMP_ENABLE_Pin|VCC_LCD_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
